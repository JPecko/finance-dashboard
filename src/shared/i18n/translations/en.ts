export const en = {
  ...
  recurring: {
    ...
    groupExpenseDesc:  'Generate a group expense (with split) each time this rule fires, instead of a personal transaction',
    groupNotAMember:   "You're not a member of this group",
    dateRuleExact:            'Exact day',
    dateRuleFirstBusinessDay: 'First business day',
    adjustToBusinessDay:      'Adjust to next business day',
    adjustToBusinessDayDesc:  'If the date falls on a weekend, move it to the next business day',
    ruleName:            'Rule Name',
    ruleNamePlaceholder: 'e.g. Monthly Rent',
    ruleNamePlaceholderGroup: 'e.g. Monthly Rent Split',
    from:                'From',
    to:                  'To',
    source:              'Source',
  ...
  investments: {
    ...
    incomeContribTitle:      'Invested via Income',
    incomeContribSubtitle:   'Contributions from income tagged as an investment move, matched to the purchases they funded and valued at real price history',
    incomeContribTotal:      'Total Contributed',
    incomeContribUnmatchedOnly: 'Could not match any of these contributions to an imported purchase (same date/amount) — no valuation available.',
    incomeContribUnmatchedNote: '{{count}} contribution(s) could not be matched to an imported purchase — excluded from the valuation above.',
    incomeContribNearest:    'closest purchase: {{date}} totaling {{amount}} ({{days}}d away)',
    incomeContribNoPurchases: 'this account has no imported purchases at all',
